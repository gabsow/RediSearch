 ...
 * [valid]: https://doc.rust-lang.org/std/ptr/index.html#safety
 */
int32_t RLookup_LoadRuleFields(RedisSearchCtx *search_ctx, struct RLookup *lookup, struct RLookupRow *dst_row, IndexSpec *index_spec, const char *key, struct QueryError *status);
